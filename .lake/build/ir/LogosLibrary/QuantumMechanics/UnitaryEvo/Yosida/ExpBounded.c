...
// Module: LogosLibrary.QuantumMechanics.UnitaryEvo.Yosida.ExpBounded
...
LEAN_EXPORT lean_object* initialize_logos__library_LogosLibrary_QuantumMechanics_UnitaryEvo_Yosida_ExpBounded(uint8_t builtin) {
lean_object * res;

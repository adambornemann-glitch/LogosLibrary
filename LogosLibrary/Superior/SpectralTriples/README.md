...
```
Triples/SpectralDefs.lean          The alphabet: signs, types, classification
     │
Triples/SpectralAction.lean        The grammar: spectral action, Seeley-DeWitt, Triples/correspondence
     │
Triples/ProductGeometry.lean       The sentence: fiber bundle decomposition, Kaluza-Klein
     │
Triples/ConcreteSpectrum.lean      The speech: explicit S³ spectrum, DeWitt metric, couplings
```
...
## Other Triples
Eric Weinstein's `Geometric Unity` reformulated with X³ as the base is
a spectral triple!  Read more about it [here](GeometricUnity/README.md)

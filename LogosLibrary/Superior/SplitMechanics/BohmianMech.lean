...
Filename: SplitMechanics/BohmianMechanics.lean
-/
...
/-!
=====================================================================
# LORENTZ COVARIANT BOHMIAN MECHANICS v1
=====================================================================
...
open MinkowskiSpace RelativisticTemperature ThermalTime.Basic ThermalTime.Measure
/-!
=====================================================================
...
theorem chsh_tsirelson_bound (model : ThermalHiddenVariableModel) :
  ...
  calc |model.S_classical + model.S_thermal|
      ≤ |model.S_classical| + |model.S_thermal| := abs_add_le _ _

...
namespace Superior.ShapeDynamics.Synthesis
/-!
...
theorem fractions_sum_to_one (E_grav k_B T : ℝ) (hE : E_grav > 0) (hk : k_B > 0)
  ...
  rw [div_add_div_same, div_self (ne_of_gt h_denom)]
...
theorem quantumFraction_decreasing (E_grav k_B T₁ T₂ : ℝ)
  ...
  simp_all only [gt_iff_lt, ge_iff_le, mul_lt_mul_left, _root_.add_lt_add_iff_left]
...
end Superior.ShapeDynamics.Synthesis
